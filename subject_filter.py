...
Original file is located at
    https://colab.research.google.com/drive/1ltPqHu1b7XnoefwK_0zbJYdlnMZhJF76
"""

from triggam_tagger import SubjectTrigramTagger
...
if __name__ == '__main__':
    url = 'https://en.wikipedia.org/wiki/Wroclaw'
    document = download_document(url)

    #with open('/content/test.txt') as f:
        #document = f.readlines()        

    #document = open("/content/test.txt")
